"""Pro Passive Recon Tool - improved version

Features:
- WHOIS, DNS, CRT.SH subdomains, Wayback URLs, HTTP headers, ASN (ipinfo.io)
- Robust HTTP session with retries and timeouts
- CLI flags for JSON output and output directory
- Improved error handling and safe serialization
"""
import argparse
import json
import os
	...
	try:
		...
		if r.status_code == 200:
			try:
				...
				# crt.sh sometimes returns non-json responses
